---
{"dg-publish":true,"permalink":"/publishing/main/noter/vita/broken-object-property-level-authorization/","created":"2024-11-06T07:49:50.035+01:00"}
---
...
For at løse sårbarheder ved "**Excessive Data Exposure**" og "**Mass Assignment**" i [[Publishing/Main/Noter/Programmering/API\|API-endpoints]] kan man:
...
Denne type validering kan implementeres i en *fælles auth-service* eller *som middleware*, der håndterer alle [[Publishing/Main/Noter/Programmering/API\|API-requests]] til de relevante endpoints og sikrer, at kun nødvendige egenskaber er tilgængelige for brugeren.
...
#### Hvor bruges dette i en microservice?
Her kan man skabe en [[Publishing/Main/Noter/Programmering/Data Transfer Object\|DTO]] for kun at returnere de nødvendige egenskaber i microservices, som typisk håndterer brugerprofiler eller følsomme data. [[Publishing/Main/Noter/Programmering/Data Transfer Object\|DTO]]'er hjælper også med at standardisere datainput/output på tværs af services.
