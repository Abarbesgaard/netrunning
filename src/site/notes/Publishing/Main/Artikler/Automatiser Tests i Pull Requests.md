---
{"dg-publish":true,"permalink":"/publishing/main/artikler/automatiser-tests-i-pull-requests/","tags":["AutomatedTesting","GitHubActions","CICD"],"dgHomeLink":"false","dgShowBacklinks":"false","dgShowLocalGraph":"false","dgShowFileTree":"false","dgEnableSearch":"false","dgShowToc":"false","created":"2024-11-27T10:33:10.380+01:00"}
---


**At sikre kodekvalitet** er afgørende for succes i ethvert udviklingsprojekt. Automatisering af tests som en del af [[Publishing/Main/Noter/Programmering/Pull Request\|pull request]]-processen er en effektiv måde at fange fejl, sikre stabilitet og spare tid. I denne guide viser jeg, hvordan du opsætter [[Publishing/Main/Noter/Programmering/GitHub Actions\|GitHub Actions]] til at køre tests automatisk, hver gang du laver en [[Publishing/Main/Noter/Programmering/Pull Request\|pull request]] (PR).
...
>
>>[!note] 2
>Blokerer en [[Publishing/Main/Noter/Programmering/Pull Request\|PR]] fra at blive merged, hvis testene fejler.
>
>>[!note] 3
...
[[Publishing/Main/Noter/Programmering/GitHub Actions\|GitHub Actions]] er en CI/CD-platform indbygget i [[Publishing/Main/Noter/Programmering/GitHub\|GitHub]]. Det gør det muligt at opsætte *workflows*, der aktiveres ved *specifikke hændelser*, som f.eks. når en [[Publishing/Main/Noter/Programmering/Pull Request\|pull request]] oprettes eller en push laves til et bestemt branch.

Med [[Publishing/Main/Noter/Programmering/GitHub Actions\|GitHub Actions]] kan du:
...
### Opret en [[Publishing/Main/Noter/Programmering/YAML\|YAML]]-fil til din workflow
...
Denne workflow-fil er designet til at automatisere bygning og testning af en .NET-applikation, hver gang en [[Publishing/Main/Noter/Programmering/Pull Request\|pull request]] laves mod enten `main`- eller `develop`-branchen. Den bruger [[Publishing/Main/Noter/Programmering/GitHub Actions\|GitHub Actions]] til at udføre følgende trin:
...
on: 
	...
	pull_request:     
		...
		- develop
```
- **`name`**: Angiver navnet på workflowet, så det er let at identificere i [[Publishing/Main/Noter/Programmering/GitHub Actions\|GitHub Actions]]-grænsefladen.
...
**Hvad tænker du?**  
Har du erfaring med [[Publishing/Main/Noter/Programmering/GitHub Actions\|GitHub Actions]], eller mangler der noget i denne guide? Del dine tanker, forslag og spørgsmål i kommentarerne – lad os starte en diskussion om bedste praksis for test-automatisering! 🚀
