...
- **`QueueDeclare`**: Sikrer, at [[Main/Noter/RabbitMQ#Queues\|køen]] `"hello"` eksisterer. Dette er vigtigt, fordi consumeren ikke kan modtage beskeder, hvis [[Main/Noter/RabbitMQ#Queues\|køen]] ikke findes.
